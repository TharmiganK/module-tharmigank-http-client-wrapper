...
import static io.tharmigank.http.client.wrapper.HttpConstants.AND_SIGN;
import static io.tharmigank.http.client.wrapper.HttpConstants.CURRENT_TRANSACTION_CONTEXT_PROPERTY;
import static io.tharmigank.http.client.wrapper.HttpConstants.EMPTY;
import static io.tharmigank.http.client.wrapper.HttpConstants.EQUAL_SIGN;
import static io.tharmigank.http.client.wrapper.HttpConstants.MAIN_STRAND;
import static io.tharmigank.http.client.wrapper.HttpConstants.ORIGIN_HOST;
import static io.tharmigank.http.client.wrapper.HttpConstants.POOLED_BYTE_BUFFER_FACTORY;
import static io.tharmigank.http.client.wrapper.HttpConstants.QUESTION_MARK;
import static io.tharmigank.http.client.wrapper.HttpConstants.QUOTATION_MARK;
import static io.tharmigank.http.client.wrapper.HttpConstants.REMOTE_ADDRESS;
import static io.tharmigank.http.client.wrapper.HttpConstants.SINGLE_SLASH;
import static io.tharmigank.http.client.wrapper.HttpConstants.SRC_HANDLER;
